...
namespace BooleansConsts{
   ...
   constexpr bool kBackRightDriveEncoderReversed = true;
...
//MECACRONICO
    ...
    //******ANGULOS EM RADIANOS!!!!!!*******
    /* Front Right Module */
    constexpr double FR_DEGREE_OFFSET = 3.1279;//179,39°
    /* Rear Right Module */
    constexpr double RR_DEGREE_OFFSET = 3.505;//200,86°   ---->> ANTIGO 0.364;//20,86°
  ;
    /* Front Left Module */
    constexpr double FL_DEGREE_OFFSET = 1.868253; //107,05°
    /* Rear Left Module */
    constexpr double RL_DEGREE_OFFSET = 1.04410 ;//59,82°
;
}
...
namespace ArmConstants{
  ...
  //Position Constants
  constexpr double armEncInitPos = 30.0;
  constexpr double armAtShooterPosition = 29.1;
  constexpr double armAtAmpPosition = 20.0;
  constexpr double armAtGroundPosition = 1;
  constexpr double armToGroundMaxPIDPosition = 3.5;
  constexpr double armToShooterMaxPIDPosition = 26.0;
}
...
namespace ledRgbConstants{
  constexpr uint8_t RED = 0;
  constexpr uint8_t GREEN = 1;
  constexpr uint8_t BLUE = 2;
  constexpr uint8_t OFF = 3;
  constexpr uint8_t WHITE = 4;
  constexpr uint8_t YELLOW = 5;
  constexpr uint8_t PURPLE = 6;
  constexpr uint8_t CYAN = 7;
  constexpr uint8_t ORANGE = 8; 
  constexpr uint8_t PINK = 9;
  constexpr uint8_t MAGENTA = 10;
}